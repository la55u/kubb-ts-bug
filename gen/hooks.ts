...
export type FindPetsByStatusInfiniteQueryKey = ReturnType<
  typeof findPetsByStatusInfiniteQueryKey
>;
...
>(
  params?: FindPetsByStatus["queryParams"],
  options: {
    query?: InfiniteQueryObserverOptions<
      FindPetsByStatus["response"],
      FindPetsByStatus["error"],
      TData,
      TQueryData,
  ...
  const { query: queryOptions, client: clientOptions = {} } = options ?? {};
  const queryKey =
    queryOptions?.queryKey ?? findPetsByStatusInfiniteQueryKey(params);
...
export type FindPetsByTagsInfiniteQueryKey = ReturnType<
  typeof findPetsByTagsInfiniteQueryKey
>;
...
>(
  ...
  const { query: queryOptions, client: clientOptions = {} } = options ?? {};
  const queryKey =
    queryOptions?.queryKey ?? findPetsByTagsInfiniteQueryKey(params);
  const query = useInfiniteQuery({
...
export const getPetByIdInfiniteQueryKey = (
  petId: GetPetByIdPathParams["petId"],
) => [{ url: "/pet/:petId", params: { petId: petId } }] as const;
export type GetPetByIdInfiniteQueryKey = ReturnType<
  typeof getPetByIdInfiniteQueryKey
>;
...
type GetInventoryClient = typeof client<
  GetInventoryQueryResponse,
  never,
  never
>;
...
export const getInventoryInfiniteQueryKey = () =>
  [{ url: "/store/inventory" }] as const;
export type GetInventoryInfiniteQueryKey = ReturnType<
  typeof getInventoryInfiniteQueryKey
>;
...
type PlaceOrderPatchClient = typeof client<
  PlaceOrderPatchMutationResponse,
  PlaceOrderPatch405,
  PlaceOrderPatchMutationRequest
>;
...
export const getOrderByIdInfiniteQueryKey = (
  orderId: GetOrderByIdPathParams["orderId"],
) => [{ url: "/store/order/:orderId", params: { orderId: orderId } }] as const;
export type GetOrderByIdInfiniteQueryKey = ReturnType<
  typeof getOrderByIdInfiniteQueryKey
>;
...
>(
  ...
  const { query: queryOptions, client: clientOptions = {} } = options ?? {};
  const queryKey =
    queryOptions?.queryKey ?? getOrderByIdInfiniteQueryKey(orderId);
  const query = useInfiniteQuery({
...
export const loginUserInfiniteQueryKey = (params?: LoginUser["queryParams"]) =>
  [{ url: "/user/login" }, ...(params ? [params] : [])] as const;
export type LoginUserInfiniteQueryKey = ReturnType<
  typeof loginUserInfiniteQueryKey
>;
...
export const logoutUserInfiniteQueryKey = () =>
  [{ url: "/user/logout" }] as const;
export type LogoutUserInfiniteQueryKey = ReturnType<
  typeof logoutUserInfiniteQueryKey
>;
...
export const getUserByNameInfiniteQueryKey = (
  username: GetUserByNamePathParams["username"],
) => [{ url: "/user/:username", params: { username: username } }] as const;
export type GetUserByNameInfiniteQueryKey = ReturnType<
  typeof getUserByNameInfiniteQueryKey
>;
...
>(
  ...
  const { query: queryOptions, client: clientOptions = {} } = options ?? {};
  const queryKey =
    queryOptions?.queryKey ?? getUserByNameInfiniteQueryKey(username);
  const query = useInfiniteQuery({
